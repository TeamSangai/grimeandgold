...
public class GrimeBarrelScreen extends AbstractContainerScreen<GrimeBarrelMenu> {
    private static final Identifier TEXTURE = Identifier.withDefaultNamespace("textures/gui/container/dispenser.png");

    public GrimeBarrelScreen(GrimeBarrelMenu menu, Inventory inventory, Component title) {
